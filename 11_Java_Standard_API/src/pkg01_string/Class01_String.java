...
public class Class01_String {
  ...
  public static void method2() {
    ...
    // String Literal : "문자열"
    // String Literal 은 JVM이 관리한다. -> 동일한 literal은 재사용한다.
  ...
  public static void method3() {
    ...
    // "a"가 메모리에 2개 있음
    // Literal은 JVM이 관리하기 때문에 동일한 문자열 객체가 생성될 수 없었지만
    // new String("문자열")은 동일한 문자열 객체 생성이 가능하다.
  ...
  public static void method10() {
    ...
    // isBlank : 공백 문자이면 true 반환 (jdk 11부터 사용 가능)
    
    String str = " ";
        
    System.out.println(str.isEmpty());  // false -> 공백은 글자수로 치지 않음. 
  ...
  public static void method13() {
    ...
    // spit : 지정한 정규식 패턴으로 문자열을 분리한 String[] 반환
    ...
    // 배열의 요소의 인덱스는 시작 인덱스와 더불어 꼭 알아두어야 한다.
    // !!! 시작 인덱스 = 0, 마지막 인덱스 = length -1 !!!
  ...
  public static void method15() {
    ...
    // 정수 형식
    int number2 = 123;
    System.out.println(String.format("%o", number2));    // %o = 8진수
    System.out.println(String.format("%x", number2));    // %x = 16진수 (0 ~ f)
    System.out.println(String.format("%X", number2));    // %x = 16진수 (0 ~ F)
    System.out.println(String.format("%d", number2));    // %d = 10진수
    System.out.println(String.format("%05d", number2));  // %d = 10진수
