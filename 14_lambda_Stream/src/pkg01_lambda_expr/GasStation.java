 ...
 *               return 문자열
 *             }
 *    2) A a = (name) -> 문자열  // 본문 내용이 return만 있는 경우 중괄호 {}와 return 키워드를 생략할 수 있다.
...
public class GasStation {
  ...
  public void sellOil(String model, int oil) {
    // Car 타입의 car 객체 생성 (Anonymous Inner Type / 익명내부타입)
//    Car car = new Car() {  
//      @Override
//      public void addOil() {
//        totalOil -= oil;  // 오일이 줄어들면
//        earning += oil * chargePerLiter;  // 돈을 번다
