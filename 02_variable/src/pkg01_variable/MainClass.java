...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    *    2) 참조 자료형 (타입)
    *     (1) 값이 저장된 참조값을 저장하는 REFERENCE DATE 타입이다.
    *     (2) 기본 자로형을 제외한 모든 데이터는 참조 자료형이다.
    */
    ...
    // int : 4바이트 정수 - java에서 권장하는 정수 저장변수
    int b = 100; // -21억 ~ 21억
    System.out.println(b);
    
    // long : 8바이트 정수 - long타입의 숫자는 L을 붙일 수 있다.
    long c = 10L; 
    System.out.println(c);
    
    // float : 4바이트 실수 - java는 소수점이 등장하면 8바이트로 저장한다.
    float d = 1.1F;
