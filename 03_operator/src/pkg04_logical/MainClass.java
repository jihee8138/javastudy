...
public class MainClass {
  ...
  public static void main(String[] args) {
     ...
     * 2. 종류
     *  1) && : 논리 AND, 두 항이 모두 true이면 나머지 경우는 false 반환
     *  2) || : 논리 OR, 두 항 중 하나라도 true이면 true 나머지 경우는 false 반환
     *  3) !  : 논리 NOT, 전달된 항이 true이면 false 반환
     */
     ...
     * 2. 종류
     *  1) && : false가 반환되면 최종 결과도 false이므로 더 이상 동작하지 않는다.
     *  2) || : true가 반환되면 최종 결과도 true이므로 더 이상 동작하지 않는다.
     */
